...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-mainbg">
    ...
    <main class="seccion contenedor">
        <h2 class="fw-300 centrar-texto">Curso Disponibles</h2>

        <div class="contenedor-anuncios">
            <div class="anuncio">
                <img src="../Fotos/anuncio01.jpg" alt="Anuncio Mate ecuación">
                <div class="contenido-anuncio">
                        <h3>Aprende  Mate Ecuaciòn</h3>
                    <p>Aprende mate ecuación de una manera mas facil , practica y divertida sin moverte de tu casa.</p>
                    ...
                    <a href="index.php" class="boton boton-amarillo d-block">Contactanos Para Curso</a>
                </div>
            </div>
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <ul class="iconos-caracteristicas">
                        <li>
                            <img src="../Fotos/igual.png" alt="icono wc">
                            <p>3</p>
                        </li>
                        <li>
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <ul class="iconos-caracteristicas">
                        ...
                        <li>
                            <img src="../Fotos/cubo.png" alt="icono piano">
                            <p>3</p>
                        </li>
                        <li>
                            <img src="../Fotos/cubo.png" alt="icono piano">
